  ...
  return (
    <header className="bg-body dark:bg-bodyD justify-between flex p-3 xs:px-5 sm:px-12 sm:py-3 md:mx-24 md:px-0 lg:max-w-[70vw] lg:mx-auto xl:max-w-[50vw]">
      <h1
        ...
        className="font-audiowide font-normal cursor-pointer text-3xl -translate-y-[0.025em] translate-x-[0.04em] text-blue-900 dark:text-mainHeadingD"
      >
        Wetter
      </h1>
      <input
